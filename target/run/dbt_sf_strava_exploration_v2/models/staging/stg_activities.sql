        ...
        create or replace transient table STRAVA_DEV.staging.stg_activities
         as
        (-- steps
...
, activities_extracted_and_renamed AS (
    ...
    get(VALUE, 'average_speed') AS average_speed_kmhr,
    get(VALUE, 'max_speed') AS max_speed_kmhr,
...
, activities_casted AS (
    ...
    max_speed_kmhr::float AS max_speed_kmhr,
...
, activities_with_default_value_imputations AS (
    ...
    IFF(average_speed_kmhr = 0, null, average_speed_kmhr) AS average_speed_kmhr,
    IFF(max_speed_kmhr = 0, null, max_speed_kmhr) AS max_speed_kmhr,
