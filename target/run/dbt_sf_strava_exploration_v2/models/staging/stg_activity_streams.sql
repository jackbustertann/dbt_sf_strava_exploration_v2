        ...
        create or replace transient table STRAVA_DEV.staging.stg_activity_streams
         as
        (-- steps
...
, activity_streams_extracted_and_renamed AS (
    ...
    FILTER(RAW_JSON, a -> a:type = 'velocity_smooth')[0]['data'][time.index] AS speed_kmhr,
...
, activity_streams_casted AS (
    ...
    speed_kmhr::float AS speed_kmhr,
