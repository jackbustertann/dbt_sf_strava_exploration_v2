...
{% set columns_lst = [
    ...
    {'json_key': 'average_speed', 'data_type': 'float', 'column_name': 'average_speed_kmhr', 'impute_on': 'zero', 'default_value': 'null'},
    {'json_key': 'max_speed', 'data_type': 'float', 'column_name': 'max_speed_kmhr', 'impute_on': 'zero', 'default_value': 'null'},
